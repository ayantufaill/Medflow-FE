    ...
    >
      ...
      <FieldBox label="Operatory">
        ...
        >
          ...
          {(rooms || []).map((r) => {
            const roomVal = String(
              r._id || r.id || r.roomCode || r.title || r.name || "",
            );
            return (
              <MenuItem
                key={roomVal}
      ...
      <Box>
        ...
        {isProviderOccupied && (
          ...
          >
            This provider is occupied at the selected time.
          </Typography>
        )}
      </Box>
      ...
      <FieldBox label="Patient's preferred dentist">
        <Select
          ...
          sx={{
            ...
            fontSize: "13px",
            borderRadius: "8px",
            color: preferredDentist ? "#09121f" : "#9aa3ae",
          }}
        >
          <MenuItem
            value=""
          ...
          {providers.map((p) => {
            const providerId = String(
              p.ProvNum || p.providerId || p._id || p.id,
            );
            return (
              <MenuItem
                key={providerId}
      ...
      <FieldBox label="Patient's preferred hygienist">
        <Select
          ...
          sx={{
            ...
            fontSize: "13px",
            borderRadius: "8px",
            color: preferredHygienist ? "#09121f" : "#9aa3ae",
          }}
        >
          <MenuItem
            value=""
        ...
        <>
          ...
          <FieldBox label="Referred by">
            <TextField
              ...
              value={referredBy || ""}
              onChange={(e) =>
                onReferredByChange && onReferredByChange(e.target.value)
              }
              sx={{
                "& .MuiInputBase-root": {
                  fontFamily: "Inter",
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  checked={!!noReminders}
                  onChange={(e) =>
                    onNoRemindersChange && onNoRemindersChange(e.target.checked)
                  }
                  sx={{
                    color: "#d1d5db",
