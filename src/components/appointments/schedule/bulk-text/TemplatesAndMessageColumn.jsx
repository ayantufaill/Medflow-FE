...
const TemplatesAndMessageColumn = ({ message, setMessage, templates, handleTemplateClick }) => {
  return (
    <Box sx={{ width: '367px', height: '551px', flexShrink: 0, borderRadius: '12px', border: `1px solid ${COLORS.BORDER_LIGHT}`, backgroundColor: '#f8fafc', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      {/* Right Header */}
