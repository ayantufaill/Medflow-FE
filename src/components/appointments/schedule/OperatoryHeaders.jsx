    ...
    >
      ...
      {roomsLoading
        ...
        : rooms.map((room, idx) => {
            ...
            const roomId = `op${room._id || room.id}`;
            ...
            return (
              <Box
                ...
                onClick={() => {
                  if (isCloseOpenDayMode && onToggleOperatoryStatus && dateStr) {
                    onToggleOperatoryStatus(roomId);
                  }
                }}
                sx={{
                  ...
                  cursor: isCloseOpenDayMode ? 'pointer' : 'default',
                  backgroundColor: isClosed ? 'rgba(0, 0, 0, 0.03)' : 'transparent',
                  '&:hover': isCloseOpenDayMode ? { backgroundColor: 'rgba(0, 0, 0, 0.05)' } : {},
                }}
              >
