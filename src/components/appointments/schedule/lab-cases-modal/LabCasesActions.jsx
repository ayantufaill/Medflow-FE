...
const LabCasesActions = ({ onExportCSV, onPrint, expandedNotes, onToggleNotes, disabled }) => {
  return (
    <Box sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-start', mb: 2, mt: 1, gap: 1 }}>
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 1 }}>
        ...
        <Link 
          href="#" 
          underline="hover" 
          onClick={(e) => { e.preventDefault(); onToggleNotes(); }}
          sx={{ color: '#2362EF', fontSize: '0.75rem', fontWeight: 500 }}
        >
