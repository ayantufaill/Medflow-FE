...
const LedgerSubRow = ({
  ...
  const patientTotal = hasProcedures
    ? procedures.reduce((sum, proc) => sum + Number(proc.ptPortion || 0), 0)
    : 0;
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      <Box
        onClick={() => {
          if (hasProcedures) setExpanded(!expanded);
        }}
        sx={{
          display: "flex",
          alignItems: "center",
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", width: 220 }}>
          {hasProcedures &&
            (expanded ? (
              <KeyboardArrowDown
                sx={{ fontSize: 18, color: textSecondaryColor, mr: 0.5 }}
              />
            ) : (
              <KeyboardArrowRight
                sx={{ fontSize: 18, color: textSecondaryColor, mr: 0.5 }}
          ...
          {!hasProcedures && (
            <InsertDriveFileOutlined
              sx={{ fontSize: 16, color: textSecondaryColor, mr: 0.5 }}
            />
          )}
          <Typography
            variant="caption"
            sx={{ color: textSecondaryColor, fontSize: "12px", mr: 2 }}
          >
            {date}
          </Typography>
          <CalendarTodayOutlined
            sx={{ fontSize: 16, color: textSecondaryColor, mr: 1 }}
          />
        </Box>
        <Typography
          variant="caption"
          sx={{
            ...
            fontSize: "12px",
            fontWeight: isAdjustment ? 400 : 600,
            display: "flex",
            alignItems: "center",
            gap: 1,
          }}
        >
          {title.includes("(uncollected)") ? (
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Typography
                variant="caption"
                sx={{ color: textPrimaryColor, fontSize: "12px" }}
              >
            ...
            >
              {isAdjustment ? "Adjustment" : "Invoice"} #{id || "24636"}: [{" "}
              {title} ]{" "}
              <Box
                component="span"
          ...
          {isVoided ? null : isPatientDeposit ? (
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              <Tooltip title="Open/Close Claim" placement="top">
                <Box
                  ...
                  sx={{
                    width: 22,
                    height: 22,
                    bgcolor: isClosedClaim ? "#ffffff" : "#86efac",
                    border: isClosedClaim
                      ? "1px solid #d1d5db"
                      : "1px solid #22c55e",
                    borderRadius: "4px",
                    display: "flex",
              ...
              >
                ...
                >
                  {isUnsentClaim ? (
                    <>
                      <ShieldOutlined
                        sx={{ fontSize: 22, color: "#64748b", fill: "#e2e8f0" }}
                      />
                      <LocalHospital
                        sx={{
                          fontSize: 12,
              ...
              <Tooltip title="View EOB" placement="top">
                ...
                >
                  <Typography
                    sx={{ fontSize: "10px", color: "#fff", fontWeight: "bold" }}
                  >
                    EOB
                  </Typography>
                </Box>
              ...
              <Tooltip title="Print Claim" placement="top">
                <Box
                  onClick={(e) => {
                    e.stopPropagation();
                    onPrintClaimClick?.(eobData || attachData);
                  }}
                  sx={{
                    width: 22,
                    height: 22,
              ...
              <Tooltip title="Edit Claim" placement="top">
                <Box
                  onClick={(e) => {
                    e.stopPropagation();
                    onEditClaimClick?.(eobData || attachData);
                  }}
                  sx={{
                    width: 22,
                    height: 22,
            ...
            <>
              <Tooltip title="Adjust Invoice" placement="top">
                <Box
                  ...
                  sx={{ width: 18, height: 18, cursor: "pointer" }}
                  onClick={(e) => onAdjustmentSelect?.(e)}
                />
              </Tooltip>
              ...
              <Tooltip title="Invoice Settings" placement="top">
                <Box
                  component="img"
                  src={ButtonSettingsIcon}
                  sx={{ width: 18, height: 18, cursor: "pointer" }}
                  onClick={() => onSettingsClick?.({ id, date, title, amount })}
                />
              </Tooltip>
