...
import { ReportFilterBar, ReportSelect, ReportDivider, ReportCheckbox } from '../ui';

const PaymentPlansFilters = ({
  dateRange,
  startDate,
  endDate,
  selectedStatus,
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      <ReportSelect 
        ...
        options={[
          ...
          { value: 'Manual Fee', label: 'Manual Fee' },
          { value: 'Regular Invoice', label: 'Regular Invoices' },
          { value: 'Membership Plan', label: 'Membership Plans' },
        ]}
        value={filterType}
...
export default PaymentPlansFilters;
