  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center' }}>
        ...
        <Button variant="outlined" onClick={onCancel} sx={{ textTransform: 'none', color: '#333', borderColor: '#DFE5EC', fontWeight: 600, height: 32, px: 2, borderRadius: 1.5 }}>Cancel</Button>
        <Button variant="contained" onClick={onSave} disabled={loading} sx={{ bgcolor: '#2362EF', textTransform: 'none', fontWeight: 600, height: 32, px: 3, boxShadow: 'none', borderRadius: 1.5 }}>Save</Button>
      </Box>
    </Box>
  );
};
