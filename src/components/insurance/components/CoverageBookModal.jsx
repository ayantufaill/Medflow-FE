      ...
      <>
        ...
        <TableCell sx={cellStyle} align="center">
          ...
          >
            ...
            <input
              style={inputStyle}
              value={proc.maxAllowed || ""}
              onChange={(e) => onChange("maxAllowed", e.target.value)}
            />
          </Box>
        </TableCell>
        ...
        <TableCell sx={cellStyle} align="center">
          ...
          >
            ...
            <input
              style={inputStyle}
              value={proc.lifetimeLimit || ""}
              onChange={(e) => onChange("lifetimeLimit", e.target.value)}
            />
          </Box>
        </TableCell>
        ...
        <TableCell sx={cellStyle} align="center">
          <Box
            ...
            onClick={() => code && setActiveToothSelection(code)}
          >
            <ToothIcon sx={{ fontSize: 16, color: "#1976d2" }} />
            {proc.teethLimit && (
              <Typography sx={{ fontSize: "0.65rem", color: "#1976d2" }}>
                {proc.teethLimit.length > 5
                  ? proc.teethLimit.substring(0, 5) + "..."
                  : proc.teethLimit}
              </Typography>
            )}
          </Box>
        ...
        <TableCell sx={cellStyle} align="center">
          ...
          >
            ...
            <input
              style={inputStyle}
              value={proc.flatPlanPortion || ""}
              onChange={(e) => onChange("flatPlanPortion", e.target.value)}
            />
          </Box>
        </TableCell>
      </>
          ...
          {loading ? (
            ...
            >
              <Typography color="textSecondary">
                Please select a Plan Fee Guide on the coverage form first to
                load procedures.
              </Typography>
            </Box>
          ) : (
              ...
              <TableContainer sx={{ flex: 1, overflow: "auto" }}>
                ...
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell sx={{ ...headerCellStyle, width: "13%" }}>
                      Group
                    </TableCell>
                    <TableCell sx={{ ...headerCellStyle, width: "6%" }}>
                      Code
                    </TableCell>
                    ...
                    <TableCell
                      sx={{ ...headerCellStyle, width: "8%" }}
                      align="center"
                    >
                      Down-grade
                    </TableCell>
                    <TableCell
                      sx={{ ...headerCellStyle, width: "4%" }}
                      align="center"
                    >
                      NC
                    </TableCell>
