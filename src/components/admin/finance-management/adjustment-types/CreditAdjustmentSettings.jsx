...
const CreditAdjustmentSettings = ({ data, section = 'credit', onAdd, onInputChange, onDelete }) => {
  return (
...
export default CreditAdjustmentSettings;
