...
const DebitAdjustmentSettings = ({ data, section = 'debit', onAdd, onInputChange, onDelete }) => {
  return (
...
export default DebitAdjustmentSettings;
