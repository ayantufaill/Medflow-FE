                                          ...
                                          {examView === 'Chart View' ? (
                                            <Box sx={{ bgcolor: '#fff', p: 2, border: '1px solid #eee', borderRadius: 1, width: '100%', position: 'relative' }}>
                                              <InteractiveToothChart
                                                ...
                                                onQuadrantToggle={(teethArray) => {
                                                  setProgressSelectedTeeth(prev => {
                                                    const allSelected = teethArray.every(t => prev.includes(t));
                                                    if (allSelected) {
                                                      return prev.filter(t => !teethArray.includes(t));
                                                    } else {
                                                      return [...new Set([...prev, ...teethArray])];
                                                    }
                                                  });
                                                }}
                                              />
