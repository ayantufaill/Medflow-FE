...
const INITIAL_CLAIMS = [
  ...
  },
  {
    ...
    description:
      "F/U 06/05/2026 BH. We have submitted the required digital charting. Previous SRP History: 06/01/2024.",
    procedures: [
      {
        code: "D4341",
        name: "Periodontal Scaling & Root Planing - 4+ Teeth",
        fee: 280.0,
      },
      { code: "D4910", name: "Periodontal Maintenance", fee: 140.0 },
    ],
  ...
  },
  {
    ...
    procedures: [
      {
        code: "D2331",
        name: "Resin-Based Composite - 2 Surfaces, Anterior",
        fee: 210.0,
      },
    ],
    tab: "unsent",
  },
  {
    ...
    procedures: [
      { code: "D1110", name: "Prophylaxis - Adult", fee: 95.0 },
      { code: "D1208", name: "Topical Application of Fluoride", fee: 35.0 },
    ],
    tab: "unsent",
  },
  {
    ...
    procedures: [
      {
        code: "D6010",
        name: "Surgical Placement of Implant Body - Endosteal",
        fee: 1950.0,
      },
    ],
    tab: "unsent",
  ...
  },
  {
    ...
    procedures: [
      {
        code: "D0150",
        name: "Comprehensive Oral Evaluation - New Patient",
        fee: 110.0,
      },
      {
        code: "D0210",
  ...
  },
  {
    ...
    description: "Member is not active on DOS Eff...",
    procedures: [
      { code: "D3330", name: "Endodontic Therapy - Molar Tooth", fee: 980.0 },
    ],
    tab: "unsent",
  },
  {
  ...
  // 10-15: ERRORED CLAIMS
  {
    ...
    description: "Paid Amount$169.00 Patient res...",
    procedures: [
      { code: "D0150", name: "Comprehensive Oral Evaluation", fee: 110.0 },
    ],
    tab: "errored",
    redAttachment: true,
  },
  {
    ...
    status: "error",
    clearingHouseMessage:
      "Status Response (A3): Returned validation errors on claim subscriber info",
    notes: "Subscriber ID format does not match Metlife requirements.",
    description:
      "Onlay Preps #18, 19, 30 Prep Date: 01/08/2026 Seat Date: 01/29/2026 Dx: Babar Magsi sease with erosion into dentin...",
    procedures: [
      {
        code: "D2643",
        name: "Onlay - Porcelain/Ceramic - Three Surfaces",
        fee: 940.0,
      },
      {
        code: "D2644",
        name: "Onlay - Porcelain/Ceramic - Four+ Surfaces",
        fee: 1050.0,
      },
    ],
    tab: "errored",
  ...
  },
  {
    ...
    status: "error",
    clearingHouseMessage:
      "Status Response (A3): Returned claim rejected by payer - invalid tooth number",
  ...
  },
  {
    ...
    status: "eobUploaded",
    clearingHouseMessage:
      "Status Response (A3): Returned claim processed - payment pending",
  ...
  // 18-30: HISTORY CLAIMS
  {
    ...
    status: "inProcess",
    clearingHouseMessage:
      "Status Response (A0): The claim has been received by the clearinghouse.",
    notes: "Sent digitally via Medflow portal.",
    description: "Crown Prep 05/20/2026 06/16/2026",
    procedures: [
      { code: "D2740", name: "Crown - Porcelain/Ceramic", fee: 1150.0 },
    ],
    tab: "history",
    redAttachment: false,
  },
  {
    ...
    procedures: [{ code: "D1110", name: "Prophylaxis - Adult", fee: 95.0 }],
    tab: "history",
    redAttachment: false,
  },
  {
    ...
    description: "",
    procedures: [
      { code: "D4341", name: "Periodontal Scaling & Root Planing", fee: 280.0 },
    ],
    tab: "history",
    redAttachment: true,
  },
  {
    ...
    description: "",
    procedures: [
      { code: "D0120", name: "Periodic Oral Evaluation", fee: 55.0 },
    ],
    tab: "history",
    redAttachment: false,
  },
  {
    ...
    status: "accepted",
    clearingHouseMessage:
      "Status Response (A2): Acknowledged/Accept at payer level.",
    notes: "",
    description: "",
    procedures: [
      { code: "D2331", name: "Resin-Based Composite - 2 Surfaces", fee: 210.0 },
    ],
    tab: "history",
    redAttachment: false,
  },
  ...
  },
  {
    ...
    description: "",
    procedures: [
      { code: "D2950", name: "Core Buildup, Including Any Pins", fee: 245.0 },
    ],
    tab: "history",
    redAttachment: false,
  },
  ...
  },
  {
    ...
    description: "",
    procedures: [
      { code: "D3330", name: "Endodontic Therapy - Molar", fee: 980.0 },
    ],
    tab: "history",
    redAttachment: false,
  },
  ...
  // 31-32: OUTSTANDING CLAIMS
  {
    ...
    clearingHouseMessage:
      "Status Response (A2): Acknowledged/Accept at payer level.",
    submittedValue: 318.0,
    notes: "Prior authorization confirmed",
    description: "",
    procedures: [
      { code: "D0120", name: "Periodic Oral Evaluation", fee: 55.0 },
      { code: "D0210", name: "Intraoral - Complete Series", fee: 263.0 },
    ],
    tab: "outstanding",
    redAttachment: false,
  },
  {
    ...
    clearingHouseMessage:
      "Status Response (A0): The claim has been received by the clearinghouse.",
    submittedValue: 5900.0,
    notes: "Sent digitally.",
    description: "F/U 06/01/2026 BH.",
    procedures: [{ code: "D6010", name: "Implant Placement", fee: 5900.0 }],
    tab: "outstanding",
    redAttachment: false,
  },
  ...
  },
  {
    ...
    description: "",
    procedures: [
      { code: "D2331", name: "Resin Composite - 2 Surfaces", fee: 210.0 },
    ],
    tab: "predetermination",
    attachmentColor: "red",
  },
  {
    ...
    status: "inProcess",
    clearingHouseMessage:
      "Status Response (A1): The claim is in process at the payer.",
  ...
  },
  {
    ...
    description: "",
    procedures: [
      { code: "D7140", name: "Extraction, Erupted Tooth", fee: 185.0 },
    ],
    tab: "predetermination",
    attachmentColor: "green",
  },
...
const INITIAL_ERA_REPORTS = [
  // ACTIVE CLAIMS (eraTab = 'active')
  {
    ...
    carrier: "Blue Cross Blue Shield of Texas",
    status: "Paid",
    amountSubmitted: 1205.0,
    amountPaid: 964.0,
    patientResponsibility: 241.0,
    writeOff: 0.0,
  ...
  },
  {
    ...
    carrier: "Guardian Life",
    status: "Paid",
    amountSubmitted: 130.0,
    amountPaid: 104.0,
    patientResponsibility: 26.0,
    writeOff: 0.0,
...
const REJECTED_MOCK_DATA = [
  {
    ...
    clearingHouseMessage:
      "Reject Reason: Patient eligibility not found on date of service.",
    notes:
      "Checked insurance card, subscriber ID matches but coverage terminated.",
...
const ClaimsListPage = () => {
  ...
  const [subscriberDialog, setSubscriberDialog] = useState({
    open: false,
    data: null,
  });
  ...
  useEffect(() => {
    ...
    if (debouncedSearchPatient) {
      ...
      patientService
        .getAllPatients(1, 10, debouncedSearchPatient)
        .then((res) => {
          if (active) {
        ...
        if (activeTab === 6) {
          ...
          if (activeTab >= 0 && activeTab <= 3) {
            ...
            const filterParams = {
              ...
              ...(claimAttachment !== "all" && {
                hasAttachment:
                  claimAttachment === "with_attachments" ? "true" : "false",
              }),
            ...
            fetchedClaims = (data.claims || []).map((c) =>
              mapClaimFields(c, "claims"),
            );
          } else if (activeTab === 4) {
            const data = await claimService.getOutstandingClaims({
              limit: 500,
              dateRange: groupDateRange,
              groupBy: groupByOption,
              search: debouncedSearchClaimOrDate || debouncedSearchPatient,
            });
            fetchedClaims = (data.claims || []).map((c) =>
              mapClaimFields(c, "outstanding"),
            );
          } else if (activeTab === 5) {
            const data = await claimService.getPredeterminations({
              limit: 100,
            });
            fetchedClaims = (data.claims || []).map((c) =>
              mapClaimFields(c, "predetermination"),
            );
          }
          if (active) {
  ...
  const validationErrorCount = useMemo(() => {
    return claims.filter((c) =>
      ["denied", "rejected", "validationError", "error"].includes(c.status),
    ).length;
  }, [claims]);
  ...
  const handleNoteSave = async () => {
    ...
    try {
      ...
      await claimService.updateClaim(notePopover.claimId, {
        notes: notePopover.text,
      });
    ...
    try {
      ...
      setClaims((prev) => {
        return prev.filter((c) => {
          ...
          if (
            activeTab === 1 &&
            !["error", "validationError"].includes(newStatus)
          )
            return false;
  ...
  const handleDeletePredetermination = async (claimId) => {
    if (
      window.confirm("Are you sure you want to delete this predetermination?")
    ) {
      try {
        setLoading(true);
  ...
  const filteredClaims = useMemo(() => {
    let result = claims.filter((claim) => {
      ...
      if (claimAttachment !== "all") {
        if (
          claimAttachment === "with_attachments" &&
          !claim.redAttachment &&
          ...
          return false;
        if (
          claimAttachment === "without_attachments" &&
          (claim.redAttachment ||
            claim.attachmentColor === "green" ||
            claim.attachmentColor === "red")
        )
      ...
      if (searchClaimOrDate.trim()) {
        ...
        const createdMatch =
          claim.createdDate &&
          claim.createdDate.toLowerCase().includes(cleanSearch);
        const sentMatch =
          claim.sentDate && claim.sentDate.toLowerCase().includes(cleanSearch);
        const printedMatch =
          claim.printedDate &&
          claim.printedDate.toLowerCase().includes(cleanSearch);
        if (
  ...
  const handleConvertType = async (newType) => {
    ...
    const selectedIds = Object.keys(selectedClaims).filter(
    ...
    try {
      ...
      await Promise.all(
        selectedIds.map((id) =>
          claimService.updateClaim(id, { claimFormat: newType }),
        ),
      );
      setSelectedClaims({});
      setRefreshTrigger((prev) => prev + 1);
      setSnackbarMessage(
        `Converted ${selectedIds.length} claim(s) to ${newType}.`,
      );
      setSnackbarOpen(true);
    } catch (err) {
      console.error(err);
  ...
  const handleChangeStatusAction = async (newStatus) => {
    ...
    try {
      ...
      await Promise.all(
        selectedIds.map((id) =>
          claimService.quickStatusUpdate(
            id,
            newStatus,
            "Bulk updated via Change Status",
          ),
        ),
      );
  ...
  const handleSendClaims = async () => {
    ...
    const errorsSelected = claims.some(
      (c) => selectedIds.includes(c.id) && c.status === "validationError",
    );

    if (errorsSelected) {
      alert(
        "Cannot send claims with validation errors. Please resolve errors first.",
      );
      return;
    }
    ...
    try {
      ...
      setRefreshTrigger((prev) => prev + 1);
      alert(
        `Successfully sent ${selectedIds.length} claim(s)! They are now in the OUTSTANDING CLAIMS tab.`,
      );
    } catch (err) {
      console.error(err);
  ...
  const handleSendPredeterminations = async () => {
    ...
    try {
      ...
      setRefreshTrigger((prev) => prev + 1);
      alert(
        `Successfully sent ${selectedIds.length} predetermination(s) to clearinghouse!`,
      );
    } catch (err) {
      console.error(err);
  ...
  const confirmVoidAndRecreate = async () => {
    ...
    try {
      ...
      setRefreshTrigger((prev) => prev + 1);
      setSnackbarMessage(
        `Voided and Recreated ${selectedIds.length} claim(s). They are now in the UNSENT CLAIMS tab.`,
      );
      setSnackbarOpen(true);
    } catch (err) {
      console.error(err);
  ...
  const handleExportCSV = () => {
    const headers =
      "Patient Name,Claim #,Claim Type,Sent on,Printed on,Carrier,Status,ERA Status,Clearing House Status Message,Description\n";
  ...
  const handleSaveEdit = async () => {
    ...
    const hasSubmittedVal =
      editingClaim.submittedValue !== undefined &&
      editingClaim.submittedValue !== null &&
      editingClaim.submittedValue !== "";
    const hasClaimAmount =
      editingClaim.claimAmount !== undefined &&
      editingClaim.claimAmount !== null &&
      editingClaim.claimAmount !== "";
    ...
    if (hasClaimAmount || hasSubmittedVal) {
      cAmount = parseFloat(
        editingClaim.claimAmount || editingClaim.submittedValue || 0,
      );
      sAmount = parseFloat(
        editingClaim.submittedAmount || editingClaim.submittedValue || 0,
      );
      if (isNaN(cAmount) || cAmount < 0)
        errors.submittedAmount = "Must be a valid positive amount";
      if (isNaN(sAmount) || sAmount < 0)
        errors.submittedAmount = "Must be a valid positive amount";
    }

    const isErrorStatus = ["error", "validationError"].includes(
      editingClaim.status,
    );
    const currentNotes =
      editingClaim.notes ||
      editingClaim.description ||
      editingClaim.clearingHouseMessage ||
      "";
    if (isErrorStatus && !currentNotes.trim()) {
      errors.notes =
        "Status message or notes are required when setting an error status";
    }
    ...
    try {
      ...
      setClaims((prev) => {
        return prev.filter((c) => {
          ...
          if (activeTab === 1 && !["error", "validationError"].includes(ns))
            return false;
      ...
      if (isErrorStatus) {
        setSnackbarMessage(
          `Claim successfully updated and moved to Errored status`,
        );
      } else {
        setSnackbarMessage(
          `Claim successfully updated to ${editingClaim.status}`,
        );
      }
      setSnackbarOpen(true);
    } catch (err) {
  ...
  const handleToggleHide = async (claim) => {
    try {
      ...
      setRefreshTrigger((prev) => prev + 1);
      setSnackbarMessage(
        `Claim ${newHidden ? "hidden" : "unhidden"} successfully`,
      );
      setSnackbarOpen(true);
    } catch (err) {
      console.error(err);
  ...
  const handleSaveAttach = async ({ newFiles, retainedFiles }) => {
    try {
      ...
      if (removedFiles.length > 0) {
        await Promise.allSettled(
          removedFiles.map((file) => {
            if (file.id) {
              return claimService.removeClaimDocument(
                attachingClaim.id,
                file.id,
              );
            }
      ...
      if (newFiles && newFiles.length > 0) {
        const response = await claimService.uploadAttachments(
          attachingClaim.id,
          newFiles,
        );
        newAttachments =
          response.data?.attachments ||
          newFiles.map((f) => ({ id: Math.random(), name: f.name }));
      }
      ...
      if (newFiles?.length > 0)
        msgParts.push(`attached ${newFiles.length} file(s)`);
      if (removedFiles.length > 0)
        msgParts.push(`removed ${removedFiles.length} file(s)`);

      if (msgParts.length > 0) {
        setSnackbarMessage(
          `Successfully ${msgParts.join(" and ")} for claim ${attachingClaim.claimNumber}`,
        );
        setSnackbarOpen(true);
    ...
    <Box sx={{ p: 2 }}>
          ...
          <Box sx={{ display: "flex", gap: 1 }}>
            <Button
              ...
              sx={{
                ...
                color: "#ffffff",
                backgroundColor:
                  activeEraTab === "active" ? "#bc9363" : "#dbcaaf",
                borderRadius: "4px",
                px: 2.5,
                py: 0.6,
            ...
            <Button
              ...
              sx={{
                ...
                color: "#ffffff",
                backgroundColor:
                  activeEraTab === "voided" ? "#bc9363" : "#dbcaaf",
                borderRadius: "4px",
                px: 2.5,
                py: 0.6,
                "&:hover": { backgroundColor: "#a67d4e" },
          ...
          <Grid container spacing={2.5}>
                ...
                <Box>
                  ...
                  <FormControl fullWidth size="small">
                    ...
                    >
                      ...
                      <MenuItem value="sent_date" sx={{ fontSize: "0.85rem" }}>
                        Sent Date
                      </MenuItem>
                      <MenuItem
                        value="printed_date"
                      ...
                      <MenuItem value="carrier" sx={{ fontSize: "0.85rem" }}>
                        Carrier
                      </MenuItem>
                    </Select>
                  </FormControl>
                ...
                <Autocomplete
                  ...
                  renderOption={(props, option) => (
                    ...
                    >
                      <Typography
                        variant="body2"
                        sx={{ fontWeight: 600, color: "#2b3445" }}
                      >
                        {option.firstName} {option.lastName}{" "}
                        {option.patientCode ? `(#${option.patientCode})` : ""}
                      </Typography>
                      {option.dateOfBirth && (
            ...
            <Grid item xs={12} sm={6}>
              <Box>
                ...
                >
                  {activeTab === 5
                    ? "Search by claim number or sent date:"
                    : "Search by claim number or sent date:"}
                </Typography>
                <TextField
                  fullWidth
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setShowInactivePolicies(e.target.checked)
                        }
                        sx={{
                          color: "#cbd5e1",
                          "&.Mui-checked": { color: "#1a3a6b" },
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
            {activeTab === 0 && validationErrorCount > 0 && (
              ...
              >
                ...
                {validationErrorCount} claim/s have an alert. Please fix the
                validation errors before sending claims.
              </Typography>
            )}
            <Typography
              sx={{ color: "#1a3a6b", fontSize: "0.85rem", fontWeight: 700 }}
            >
              (
              {activeTab === 4
                ? 61
          ...
          >
            {(activeTab === 1 ||
              ...
              >
                {expandAllMessages
                  ? "Collapse all Clearing House Message"
                  : "Expand all Clearing House Message"}
              </Button>
            )}
                ...
                <>
                  <Button
                    ...
                    sx={{
                      ...
                      "&.Mui-disabled": {
                        backgroundColor: "rgba(125, 156, 196, 0.4)",
                        color: "#ffffff",
                      },
                    }}
                  >
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      "&.Mui-disabled": {
                        backgroundColor: "rgba(229, 197, 158, 0.4)",
                        color: "rgba(61, 48, 33, 0.4)",
                      },
                    }}
                  >
                    Send Claims
      ...
      {loading ? (
        ...
        >
          ...
          <Typography
            sx={{ color: "#4a5568", fontSize: "0.9rem", fontWeight: 500 }}
          >
            Loading data...
          </Typography>
        </Box>
      ) : activeTab === 6 ? (
        <DenticalReportsTable
          filteredDenticalReports={filteredDenticalReports}
        />
      ) : activeTab === 7 ? (
                ...
                filteredEraReports.map((era) => {
                  ...
                  return (
                    <TableRow
                      ...
                      sx={{
                        "&:hover": {
                          backgroundColor: "rgba(26, 58, 107, 0.03) !important",
                        },
                    ...
                    >
                      ...
                      <TableCell sx={{ py: 1.5 }}>
                        <Typography
                          sx={{ fontSize: "0.8rem", color: "#4a5568" }}
                        >
                          {era.carrier}
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell sx={{ py: 1.5 }}>
                        ...
                        >
                          $
                          {era.amountSubmitted.toLocaleString("en-US", {
                      ...
                      <TableCell sx={{ py: 1.5 }}>
                        ...
                        >
                          $
                          {era.amountPaid.toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell sx={{ py: 1.5 }}>
                        ...
                        >
                          $
                          {era.patientResponsibility.toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell sx={{ py: 1.5 }}>
                        <Typography
                          sx={{ fontSize: "0.8rem", color: "#718096" }}
                        >
                          $
                          {era.writeOff.toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </Typography>
                      </TableCell>
                      ...
                      >
                          ...
                          <Typography
                            onClick={(e) => {
                              ...
                              const targetInvoiceId =
                                getSafeId(claim.invoiceId) ||
                                getSafeId(claim.invoice);
                              const targetPatientId =
                                getSafeId(claim.patientId) ||
                                getSafeId(claim.patient);
                              if (targetInvoiceId && targetPatientId) {
                                ...
                                alert(
                                  "Missing invoice or patient information for this claim.",
                                );
                              }
                            }}
                            sx={{
                        ...
                        <TableCell>
                          ...
                          >
                            <Typography
                              component="span"
                              sx={{ color: "#2b659b", fontSize: "0.85rem" }}
                            >
                          ...
                          <Typography
                            onClick={async (e) => {
                              ...
                              if (carrierIdToFetch) {
                                ...
                                try {
                                  const carrierData =
                                    await insuranceCompanyService.getInsuranceCompanyById(
                                      carrierIdToFetch,
                                    );
                                  setCarrierDialog({
                                    open: true,
                        ...
                        {activeTab === 4 && (
                          <TableCell sx={{ verticalAlign: "top" }}>
                            ...
                            >
                              $
                              {(claim.submittedValue || 0).toLocaleString(
                                "en-US",
                                {
                                  minimumFractionDigits: 2,
                        ...
                        <TableCell sx={{ verticalAlign: "top" }}>
                          <IconButton
                            size="small"
                            onClick={(e) =>
                              handleNoteOpen(e, claim.notes, claim.id)
                            }
                            sx={{
                              color: "#a0aec0",
                              "&:hover": { color: "#1a3a6b" },
                              ...
                              >
                                {(() => {
                                  if (claim.description.includes(" CC ")) {
                                    ...
                                    claim.description.includes(" (KS6 ")
                                  ) {
      ...
      >
        <MenuItem
          onClick={() => handleConvertType("Manual")}
          sx={{ fontSize: "0.85rem", color: "#1a3a6b" }}
        >
          To Manual
        </MenuItem>
        <MenuItem
          onClick={() => handleConvertType("Electronic")}
          sx={{ fontSize: "0.85rem", color: "#1a3a6b" }}
        >
          To Electronic
        </MenuItem>
      ...
      >
        <MenuItem
          onClick={() => handleChangeStatusAction("readyForSubmission")}
          sx={{ fontSize: "0.85rem" }}
        >
          Ready for Submission
        </MenuItem>
        <MenuItem
          onClick={() => handleChangeStatusAction("inProcess")}
          sx={{ fontSize: "0.85rem" }}
        >
          In Process
        </MenuItem>
        <MenuItem
          onClick={() => handleChangeStatusAction("accepted")}
          sx={{ fontSize: "0.85rem" }}
        >
          Accepted
        </MenuItem>
        <MenuItem
          onClick={() => handleChangeStatusAction("acceptedPaid")}
          sx={{ fontSize: "0.85rem" }}
        >
          Accepted / Paid
        </MenuItem>
        <MenuItem
          onClick={() => handleChangeStatusAction("rejected")}
          sx={{ fontSize: "0.85rem" }}
        >
          Rejected
        </MenuItem>
        <MenuItem
          onClick={() => handleChangeStatusAction("error")}
          sx={{ fontSize: "0.85rem" }}
        >
          Error
        </MenuItem>
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
          <TextField
            ...
            onChange={(e) =>
              setNotePopover((prev) => ({ ...prev, text: e.target.value }))
            }
            ...
            <Grid container spacing={2.5}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <FormControl fullWidth size="small">
                  ...
                  >
                    <MenuItem value="readyForSubmission">
                      readyForSubmission
                    </MenuItem>
                    ...
                    <MenuItem value="acceptedForProcessing">
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <TextField
                      ...
                      onChange={(e) =>
                        setEditingClaim({
                          ...editingClaim,
                          submittedValue: parseFloat(e.target.value) || 0,
                        })
                      }
                    />
                  </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      setEditingClaim({
                        ...editingClaim,
                        treatingProvider: e.target.value,
                      })
                    }
                  />
                </Grid>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    ...
                    if (editFormErrors.notes)
                      setEditFormErrors((prev) => ({ ...prev, notes: null }));
                  }}
                />
              </Grid>
            </Grid>
          ...
          {subscriberDialog.data && (
            ...
            >
              <TableBody>
                <TableRow>
                  <TableCell
                    sx={{ fontWeight: 600, color: "#333", width: "25%" }}
                  >
                    First Name
                  </TableCell>
                  <TableCell sx={{ color: "#555" }}>
                    {subscriberDialog.data.firstName}
                  </TableCell>
                  <TableCell
                    sx={{ fontWeight: 600, color: "#333", width: "25%" }}
                  >
                  ...
                  <TableCell sx={{ color: "#555" }}>
                    {subscriberDialog.data.lastName}
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell sx={{ color: "#555" }}>
                    {subscriberDialog.data.subscriberNumber || "—"}
                  </TableCell>
                  <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                    Date of Birth
                  </TableCell>
                  <TableCell sx={{ color: "#555" }}>
                    {subscriberDialog.data.dateOfBirth || "—"}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
      ...
      <Dialog
        ...
        onClose={() =>
          setCarrierDialog({ open: false, data: null, loading: false })
        }
        maxWidth="sm"
        fullWidth
        PaperProps={{ sx: { borderRadius: 1, overflow: "hidden" } }}
            ...
            carrierDialog.data && (
              ...
              >
                <TableBody>
                  <TableRow>
                    <TableCell
                      sx={{ fontWeight: 600, color: "#333", width: "20%" }}
                    >
                      Name
                    </TableCell>
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.name || "—"}
                    </TableCell>
                    <TableCell
                      sx={{ fontWeight: 600, color: "#333", width: "20%" }}
                    >
                  ...
                  <TableRow>
                    ...
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.payerId || "—"}
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                      Address Line 1
                    </TableCell>
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.address || "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                    ...
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.phone || "—"}
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                      Address Line 2
                    </TableCell>
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.address2 || "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                    ...
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.email || "—"}
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                      City
                    </TableCell>
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.city || "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                    ...
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.fax || "—"}
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                      State
                    </TableCell>
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.state || "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                    ...
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.website || "—"}
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: "#333" }}>
                      Zip/Postal Code
                    </TableCell>
                    <TableCell sx={{ color: "#555" }}>
                      {carrierDialog.data.zipCode || "—"}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
      ...
      >
        <DialogContent sx={{ textAlign: "center", p: 4 }}>
          <Typography variant="body1" sx={{ mb: 1, color: "#333" }}>
            Are you sure you want to Void and Recreate the selected (
            {
              Object.keys(selectedClaims).filter((id) => selectedClaims[id])
                .length
            }
            ) claim/s?
          </Typography>
