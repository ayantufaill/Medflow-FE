...
const PaymentRequest = () => {
  ...
  const handlePrint = () => {
    const printContent = document.getElementById('payment-request-print-area');
    ...
    const htmlContent = `
      <html>
        ...
        <body>
          ...
          <h2 style="text-align: center; margin-top: 0; color: #1e293b;">Payment Request Report</h2>
  ...
  return (
    <ReportLayout title="Payment Request Report:">
      ...
      {loading ? (
        ...
        <Box id="payment-request-print-area">
