...
const PaymentPlans = () => {
  ...
  const handlePrint = () => {
    const printContent = document.getElementById('payment-plans-print-area');
    ...
    const htmlContent = `
      <html>
        ...
        <body>
          ...
          <h2 style="text-align: center; margin-top: 0; color: #1e293b;">Payment Plans Report</h2>
  ...
  return (
    <ReportLayout title="Payment Plans Report:">
      ...
      {loading ? (
        ...
        <Box id="payment-plans-print-area">
