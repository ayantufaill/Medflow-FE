...
const TotalCollectionFamily = () => {
  ...
  const handlePrint = () => {
    const printContent = document.getElementById('total-collection-family-print-area');
    if (!printContent) return;

    const htmlContent = `
      <html>
        <head>
          <title>Total Collection By Family Report</title>
          <style>
        ...
        <body>
          ...
          <h2 style="text-align: center; margin-top: 0; color: #1e293b;">Total Collection By Family Report</h2>
  ...
  return (
    <ReportLayout title="Total Collection By Family Report:">
      ...
      {loading ? (
        ...
        <Box id="total-collection-family-print-area">
