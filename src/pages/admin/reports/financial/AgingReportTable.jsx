                    ...
                    {!hidePatientNames && (
                      <TableCell>
                        <Box sx={{ display: "flex", flexDirection: "column" }}>
                          ...
                          >
                            (Delta Dental Ins. Co. - Utah + Delta Dental of
                            Arkansas)
                          </Typography>
                        </Box>
                      </TableCell>
                      ...
                      <TableCell key={bucket} align="right">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ${row.buckets[bucket].pt.toFixed(2)}
                            </Typography>
                          </Box>
                          <Box
                            sx={{
                          ...
                          >
                            ...
                            <Typography
                              ...
                              sx={{ color: "#94a3b8" }}
                            >
                              ${row.buckets[bucket].ins.toFixed(2)}
                            </Typography>
                          </Box>
                        </Box>
                      </TableCell>
