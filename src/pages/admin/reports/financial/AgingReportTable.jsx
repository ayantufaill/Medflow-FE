...
const AgingReportTable = ({ loading, reportData, hidePatientNames, agingBuckets, totals, showFlags, showPaymentPlan, setSelectedPatientForNotes, selectedNames = [], setSelectedNames }) => {
        ...
        <Table id="aging-report-table" size="small">
          <TableHead>
            <TableRow sx={{ '& th': { fontSize: '0.75rem', fontWeight: 600, color: '#64748b', backgroundColor: '#f8fafc', py: 1.5, borderBottom: '1px solid #e2e8f0' } }}>
              ...
              {!hidePatientNames && <TableCell sx={{ minWidth: '180px', width: '20%' }}>Patient Name</TableCell>}
