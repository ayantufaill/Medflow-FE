...
const TotalCollectionIndividuals = () => {
  ...
  const handlePrint = () => {
    const printContent = document.getElementById('total-collection-individuals-print-area');
    if (!printContent) return;

    const htmlContent = `
      <html>
        <head>
          <title>Total Collection By Individuals Report</title>
          <style>
        ...
        <body>
          ...
          <h2 style="text-align: center; margin-top: 0; color: #1e293b;">Total Collection By Individuals Report</h2>
  ...
  return (
    <ReportLayout title="Total Collection By Individuals Report:">
      ...
      {loading ? (
        ...
        <Box id="total-collection-individuals-print-area">
