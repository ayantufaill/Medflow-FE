  ...
  return (
    <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate>
      ...
      <Grid
        container
        spacing={3}
        sx={{ fontFamily: "'Manrope', 'Segoe UI', sans-serif" }}
      >
...
const ProviderFormField = ({
  ...
  <Box sx={{ mb: 2 }}>
    ...
    >
      {label}
      {required && (
        <Box component="span" sx={{ color: "error.main", ml: 0.2 }}>
          *
        </Box>
      )}
    </Typography>
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          <Box sx={{ mb: 2 }}>
              ...
              {PROVIDER_COLORS.map((c) => (
                <Box
                  ...
                  sx={{
                    ...
                    cursor: "pointer",
                    border:
                      providerColor === c ? "2px solid #000" : "1px solid #ddd",
                  }}
                />
              ))}
              <Box
            ...
            >
              The color for the provider shows on the appointment card and as a
              background for the provider name in different parts of the
              software.
            </Typography>
          </Box>
        </Grid>
    ...
    <Box sx={{ fontFamily: "'Manrope', 'Segoe UI', sans-serif" }}>
      <Box sx={{ display: "flex", alignItems: "baseline", gap: 1.5, mb: 0.5 }}>
        ...
        <Typography
          ...
          sx={{ fontSize: "0.85rem" }}
        >
          (Dentist, Hygienist or Specialist)
        </Typography>
      </Box>

      <Typography
        variant="subtitle2"
        sx={{ fontWeight: 600, mb: 1, mt: 1, fontSize: "0.85rem" }}
      >
        Added Providers
      </Typography>
...
const Step3Users = ({ onNext, onFinishLater }) => {
  ...
  return (
    <Box>
      ...
      <Typography
        variant="subtitle2"
        sx={{ fontWeight: 600, mb: 1, fontSize: fontSize.sm }}
      >
        Added Users
      </Typography>
...
const TimeInput = ({ value, onChange, allowedPeriods = ["AM", "PM"] }) => {
  ...
  useEffect(() => {
    if (
      currentPeriod &&
      !allowedPeriods.includes(currentPeriod) &&
      allowedPeriods.length > 0
    ) {
      update(
        value.fromPeriod !== undefined
          ? "fromPeriod"
          : value.toPeriod !== undefined
            ? "toPeriod"
            : "period",
        allowedPeriods[0],
      );
  ...
  return (
    <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
      ...
      <Box
        ...
        onChange={(e) =>
          update(
            value.fromHour !== undefined
              ? "fromHour"
              : value.toHour !== undefined
                ? "toHour"
                : "hour",
            e.target.value,
          )
      ...
      <Box
        ...
        onChange={(e) =>
          update(
            value.fromMin !== undefined
              ? "fromMin"
              : value.toMin !== undefined
                ? "toMin"
                : "min",
            e.target.value,
          )
  ...
  const updateTime = (day, which, updated) => {
    ...
    if (which === "from") {
      setSchedule((prev) => ({
        ...
        [day]: {
          ...prev[day],
          fromHour: updated.fromHour,
          fromMin: updated.fromMin,
          fromPeriod: updated.fromPeriod,
        },
      }));
    } else {
      setSchedule((prev) => ({
        ...
        [day]: {
          ...prev[day],
          toHour: updated.toHour,
          toMin: updated.toMin,
          toPeriod: updated.toPeriod,
        },
      }));
    }
  };
            ...
            >
              ...
              >
                ...
                <Typography
                  variant="body2"
                  sx={{
                    color: row.closed ? NAVY : "text.secondary",
                    fontWeight: row.closed
                      ? fontWeight.semibold
                      : fontWeight.regular,
                    fontSize: fontSize.sm,
                  }}
...
const Step5ScheduleSetup = ({ onNext, onFinishLater, practiceInfoId }) => {
  ...
  const handleAddRoom = async () => {
    ...
    try {
      ...
      showSnackbar(
        err.response?.data?.error?.message || "Failed to add operatory",
        "error",
      );
    } finally {
      setSavingRoom(false);
          ...
          {timeSlots.map((slot) => (
            <Box
              ...
              sx={{
                ...
                height: SLOT_H,
                borderBottom:
                  slot.min === 45 ? "1px solid #e0e0e0" : "1px dashed #f0f0f0",
              }}
            >
              ...
              {displayRooms.map((room) => (
                <Box
                  ...
                  sx={{ borderLeft: "1px solid #e0e0e0", position: "relative" }}
                />
              ))}
            </Box>
          ))}
              ...
              return (
                <Box
                  ...
                  sx={{
                    ...
                    ...(config.striped && {
                      background:
                        "repeating-linear-gradient(45deg, #d3e4f6, #d3e4f6 10px, #bbdefb 10px, #bbdefb 20px)",
                    }),
                  }}
                >
                  <Typography
        ...
        <Box sx={{ display: "flex", gap: 3 }}>
          {[
            ...
            >
              ...
              />
              <Typography variant="body2" sx={{ fontSize: fontSize.sm }}>
                {label}
              </Typography>
            </Box>
          ))}
          ...
          {[
            ...
            >
              ...
              <Typography
                variant="body2"
                sx={{
                  color: assignment === value ? "primary.main" : "text.primary",
                  fontSize: fontSize.sm,
                }}
              >
                {label}
          ...
          {[
            ...
            >
              ...
              <Typography
                ...
                sx={{
                  color:
                    billingProvider === value ? "primary.main" : "text.primary",
                  fontSize: fontSize.sm,
                }}
              >
                {label}
