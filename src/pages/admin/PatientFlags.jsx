      ...
      <Box sx={{ p: 4 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 4 }}>
          <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} sx={{ fontSize: '0.85rem' }}>
            ...
            <Typography color="text.primary" sx={{ fontWeight: 500 }}>Patient Flags</Typography>
          </Breadcrumbs>
          
          <Stack spacing={1} alignItems="flex-end">
            <Button startIcon={<SyncIcon />} sx={{ textTransform: 'none', color: '#666' }}>Sync</Button>
            <Button startIcon={<AddIcon />} sx={{ textTransform: 'none', color: '#1976d2' }}>Add new category</Button>
          </Stack>
        </Box>
        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={6}>
            <Typography variant="subtitle2" color="textSecondary" sx={{ mb: 1 }}>Patient Communication</Typography>
            <Stack direction="row" spacing={2} sx={{ mb: 1, px: 1 }}>
              <Typography variant="caption" sx={{ fontWeight: 'bold', width: 40 }}>Color</Typography>
            ...
            <Button startIcon={<AddIcon />} sx={{ textTransform: 'none', mt: 1, color: '#9e9e9e' }} size="small">
              Add new flag
            </Button>
          </Grid>
          ...
          {/* --- COLUMN 2: BILLING --- */}
          <Grid item xs={12} md={6}>
            <Typography variant="subtitle2" color="textSecondary" sx={{ mb: 1 }}>Billing</Typography>
            <Stack direction="row" spacing={2} sx={{ mb: 1, px: 1 }}>
              <Typography variant="caption" sx={{ fontWeight: 'bold', width: 40 }}>Color</Typography>
              <Typography variant="caption" sx={{ fontWeight: 'bold' }}>Name</Typography>
            </Stack>
